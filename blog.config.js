...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'cloudwind', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '雲風智能，這是我的個人博客，記錄我的思考和文章', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cloudwind.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客，雲風，cloudwind', // 网站关键词 英文逗号隔开
